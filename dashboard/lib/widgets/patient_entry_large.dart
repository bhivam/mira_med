...
class PatientEntryLarge extends StatefulWidget {
  ...
  String attribute;
  String entryTitle;
  PatientEntryLarge(this.editHist, this.attribute, this.entryTitle,
      {super.key});
...
class _PatientEntryLargeState extends State<PatientEntryLarge> {
  ...
  Widget build(BuildContext context) {
    ...
    titleController.text =
        Hive.box("patient_info").get(widget.attribute, defaultValue: "");
        ...
        child: Column(
          ...
          children: [
            ...
            TextFormField(
                ...
                onChanged: (_) {
                  Hive.box("patient_info")
                      .put(widget.attribute, titleController.text);
                },
